...
class TPiece(Piece):
    ...
    def __init__(self) -> None:
        ...
        # T piece x coordinate is the bottom one in the middle, starts like _|_
        self.x = 4
        self.y = 2
    ...
    def move_left(
        ...
        if self.orientation == 0:
            ...
            if (
                ...
                old = [(self.y - 1, self.x), (self.y, self.x + 1), (self.y + 1, self.x)]
                new = [
                    (self.y - 1, self.x - 1),
                    (self.y, self.x - 1),
                    (self.y + 1, self.x - 1),
    ...
    def rotate_clockwise(
        ...
        if self.orientation == 0:
            if self.y < 20 and not board[self.y + 1][self.x]:
                new = [(self.y + 1, self.x)]
                ...
                new = [(self.y - 2, self.x), (self.y - 1, self.x + 1)]

        elif self.orientation == 1:
            if self.x == 0:
                if not board[self.y][self.x + 2] and not board[self.y + 1][self.x + 1]:
                    new = [(self.y, self.x + 2), (self.y + 1, self.x + 1)]

            else:
                if not board[self.y][self.x - 1]:
                    new = [(self.y, self.x - 1)]
            ...
            if self.x == 9:
                if not board[self.y - 1][self.x - 1] and not board[self.y][self.x - 2]:
        ...
        if new:
            if self.orientation == 0:
                if self.y == 20:
                    old = [(self.y, self.x - 1), (self.y, self.x + 1)]
                    self.y -= 1
                ...
                if self.x == 0:
                    old = [(self.y - 1, self.x), (self.y + 1, self.x)]
                    self.x += 1
                else:
                    old = [(self.y - 1, self.x)]
            elif self.orientation == 2:
    ...
    def fall(self) -> Tuple[List[Tuple[int, int]], List[Tuple[int, int]]]:
        ...
        if self.orientation == 0:
            ...
            new = [(self.y + 1, self.x), (self.y, self.x + 1)]
            ...
            new = [(self.y, self.x - 1), (self.y + 1, self.x), (self.y, self.x + 1)]
