...
class TPiece(Piece):
    ...
    def rotate_clockwise(
        ...
        if self.orientation == 0:
            if self.y < BOARD_HEIGHT - 1 and not board[self.y + 1][self.x]:
                new = [(self.y + 1, self.x)]
            ...
            elif self.x > 0 and not board[self.y][self.x - 1]:
                new = [(self.y, self.x - 1)]
            ...
            elif self.x < BOARD_WIDTH - 1 and not board[self.y][self.x + 1]:
                new = [(self.y, self.x + 1)]
